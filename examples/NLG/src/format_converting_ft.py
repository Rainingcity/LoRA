...
with open(os.path.join(sys.argv[1], 'train_formatted.jsonl'), 'w', encoding='utf8') as train, \
    ...
    for (idx, story) in enumerate(data['text']):
        ...
        for i in range(1, len(sentences)):
            x['context'] = context_prefix + 'previous: ' + sentences[i - 1]
